...
const contactLinks = [
  {
    ...
    svg: (
      <svg
        ...
        height="24"
        fill="currentColor"
        className="bi bi-github transition-transform transform hover:scale-110 duration-200"
        viewBox="0 0 16 16"
      >
  ...
  {
    url: "https://www.linkedin.com/in/emir-negrete-128941244/",
    name: "Linkedin",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        height="24"
        fill="currentColor"
        className="bi bi-linkedin transition-transform transform hover:scale-110 duration-200"
        viewBox="0 0 16 16"
      >
  ...
  {
    url: "https://www.instagram.com/emirgelp/",
    name: "Instagram",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        height="24"
        fill="currentColor"
        className="bi bi-instagram transition-transform transform hover:scale-110 duration-200"
        viewBox="0 0 16 16"
      >
      ...
      <div className="lg:w-1/2 flex flex-col lg:justify-start border-l lg:ml-10 gap-4">
        ...
        <div className="text-xl ml-5">
          <TypewriterComponent
            options={{
              strings: [
                `Hi, i'm <span style="color: #72B01D"text-[#72B01D]">Emir</span>`,
              ],
              autoStart: true,
              loop: true,
              html: true,
